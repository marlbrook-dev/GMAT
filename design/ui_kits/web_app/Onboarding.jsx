...
<span style={{display:'flex',alignItems:'center',gap:9}}><img src="../../assets/logo.svg" width="26" height="26" alt=""/><span style={{fontFamily:'var(--font-serif-display)',fontWeight:700,fontSize:18,color:'var(--navy-900)'}}>Start From <span style={{color:'var(--gold-600)'}}>Nowhere</span></span></span>
