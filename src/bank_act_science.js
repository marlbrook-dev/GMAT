...
{id:'AS013',section:'S',type:'S',passageId:'ASS2',passageHtml:AS_S2,sub:'Evaluating a claim',skill:'act_s_esa',diff:4,
 ...
 choices:['No, because scarification removed almost all of the difference between light and darkness.','No, because species Y germinated better in light than in darkness once scarified.','Yes, because germination in light remained below germination in darkness after scarification.','Yes, because scarification raised germination in darkness from 68 to 71 percent.'],answer:0,
...
{id:'AS018',section:'S',type:'S',passageId:'ASS3',passageHtml:AS_S3,sub:'Comparing measurements',skill:'act_s_iod',diff:3,
 ...
 choices:['Neither sediment nor water temperature can be compared between the two days.','Sediment was similar on the two days although water temperature differed.','Sediment differed greatly although water temperature was the same.','Both sediment and water temperature were much higher on Day 8.'],answer:1,
...
{id:'AS026',section:'S',type:'S',passageId:'ASS4',passageHtml:AS_S4,sub:'Experimental design',skill:'act_s_si',diff:3,
 ...
 choices:['whether the coatings adhere to steel under mechanical stress','how the coatings perform once their continuity is broken','whether mass loss can be measured on a damaged surface','how long each coating takes to cure before exposure'],answer:1,
...
{id:'AS028',section:'S',type:'S',passageId:'ASS4',passageHtml:AS_S4,sub:'Reconciling results',skill:'act_s_esa',diff:4,
 ...
 choices:['Q was applied considerably more thickly than either P or R at the start of the experiment.','Q protects only against scratching and not against salt spray.','Q performs better at lower temperatures than the chamber provided.','Q is an excellent barrier that fails relatively abruptly once it begins to break down.'],answer:3,
