...
{id:'D299',section:'DI',type:'MSR',domain:'nonmath',skill:'di_msr',diff:4,passageHtml:MSR_SET10,
 ...
 choices:['Raise its enrollment cap to 40','Assign Okonjo as its instructor','Designate Sayre 4 as a lab room','Renumber the course below 300','Lower its enrollment cap to 30'],answer:4,
 ...
 wrong:'Choice D is tempting because the course number appears in a rule, but 14:00 is after 10:00, so the number is causing no problem. Fix the rule the course actually breaks.'},
{id:'D300',section:'DI',type:'MSR',domain:'nonmath',skill:'di_msr',diff:4,passageHtml:MSR_SET10,
 ...
 choices:['BIO 110 and CHM 105','CHM 105 and PHY 210','PHY 210 and MTH 340','BIO 110 and BIO 320','BIO 320 and PHY 210'],answer:3,
 ...
 wrong:'Choice A pairs the two courses taught by Okonjo, but they meet at 09:00 and 11:00, so the instructor rule is satisfied. The conflict here is the room, not the instructor.'},
{id:'D301',section:'DI',type:'MSR',domain:'nonmath',skill:'di_msr',diff:5,passageHtml:MSR_SET10,
 ...
 choices:['BIO 110','BIO 320','None of the five','CHM 105','MTH 340'],answer:2,
...
{id:'D304',section:'DI',type:'MSR',domain:'math',skill:'di_msr',diff:4,passageHtml:MSR_SET11,
 ...
 choices:['Ardent','Cobalt','Delta','Ember','Brisk'],answer:4,
...
{id:'D305',section:'DI',type:'MSR',domain:'math',skill:'di_msr',diff:5,passageHtml:MSR_SET11,
 ...
 choices:['Brisk','Cobalt','Delta','Ardent','Funding would be split between two proposals'],answer:3,
 ...
 wrong:'Choice A assumes the earlier tiebreak still governs, but the tiebreak only applies to proposals that are actually tied. Ardent now stands above both.'}
];
