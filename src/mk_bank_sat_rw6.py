...
q('SR234','rw_cs','Text Structure and Purpose',3,
 ...
 ['To reinterpret a biographical habit as a deliberate professional practice',
  ...
  "To establish that the Fuji series was produced late in the artist's working life",
...
q('SR245','rw_cs','Text Structure and Purpose',3,
 ...
 ['To resist a single-cause explanation of a biographical fact and say why one is sought',
  ...
  "To argue that the plagiarism accusation was the decisive factor in Larsen's long silence",
  "To compare Larsen's own career"],
...
q('SR255','rw_cs','Cross-Text Connections',3,
 ...
 ['It identifies a second change that could produce the same outcome and notes that the order is unknown',
  'It denies that willows recovered along the streams',
...
LIFT = {
 'SR234': [('the Fuji series was produced late in the artist\'s working life', ', after he had changed his name many times'),
 ...
 'SR245': [('the plagiarism accusation was the decisive factor in Larsen\'s long silence', ' after her second novel'),
           ('establish the sequence of events in the later life of a novelist', ' who stopped publishing'),
           ('compare Larsen\'s own career', ' with the careers of the novelists who were her contemporaries')],
 ...
 'SR255': [('denies that willows recovered along the streams', ' at all during the decade in which the wolves were reintroduced'),
