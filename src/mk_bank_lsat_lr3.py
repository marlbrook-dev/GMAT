...
q('LL101','lsat_lr_assum','Necessary assumption',3,
 ...
 ['Shortening the opening chapters of the new series will not reduce the rate at which readers finish it for some other reason',
  'Most readers who abandon a novel do so during its opening chapters rather than later',
  'Readers who finish a novel recommend it to others more often than readers who abandon it',
  'The new series will attract readers who have not previously bought books from this publisher',
  'Novels with short opening chapters sell more copies in their first month than novels with long ones'],
...
q('LL112','lsat_lr_assum','Necessary assumption',4,
 ...
 ['The willingness to attend evening meetings is affected by the level of crime in a neighbourhood',
  'Community organisations have no effect at all on the level of crime in a neighbourhood',
...
q('LL113','lsat_lr_assum','Necessary assumption',3,
 ...
 ['A battery designed for intermittent use may perform differently under continuous drain than under the use it was designed for',
  'The competitor conducted the test knowing that it would disadvantage the manufacturer\'s batteries',
  'Most purchasers use batteries of this kind intermittently rather than continuously',
...
q('LL117','lsat_lr_assum','Sufficient assumption',3,
 ...
 ['The only training sessions in the relevant period were Monday, Tuesday and Wednesday, and Reyes missed Tuesday as well',
  ...
  'No player has ever been retained after missing three consecutive sessions',
  'Training sessions are held on Monday, Wednesday and Friday of each week',
...
q('LL118','lsat_lr_assum','Necessary assumption',4,
 ...
 ['Something about the way the company approaches foreign markets, rather than the particular markets it chose, contributed to the earlier failures',
  ...
  'The company has no more capital available now than it had at the time of the earlier ventures',
  'A venture that is unwound at a loss is worse for the company than not entering the market at all',
  'No competitor has succeeded in the South American market after failing elsewhere'],
...
q('LL141','lsat_lr_evid','Weaken',3,
 ...
 ['Guests who find the hotel on a travel site and then book directly are recorded as direct bookings',
  'The commission the hotel pays to travel sites has risen in each of the last three years',
  'Some guests who book directly are members of the hotel\'s loyalty programme',
  'The hotel\'s own site is easier to use on a telephone than most travel sites are',
  'Occupancy at the hotel is highest during the months when travel site bookings peak'],
...
q('LL147','lsat_lr_evid','Strengthen',3,
 ...
 ['The ink used in the manuscript contains a mineral found only in the region of the northern scriptorium',
  'The northern scriptorium produced more manuscripts in this period than any other in the region',
...
q('LL150','lsat_lr_evid','Weaken',3,
 ...
 ['Firms adopt weekly all staff meetings only after satisfaction has already reached a level at which staff are willing to attend them',
  ...
  'Your firm is smaller than most of the firms in the consultant\'s data'],
...
q('LL151','lsat_lr_evid','Strengthen',3,
 ...
 ['The jewellery had been moved to that drawer from another room the week before',
  ...
  'Several other valuable items were kept in plain view elsewhere in the house',
...
q('LL158','lsat_lr_evid','Weaken',3,
 ...
 ['Drivers who volunteer to be monitored are those who already consider themselves careful',
  'The device records speed and braking but not the time of day a trip is taken',
...
q('LL238','lsat_lr_expl','Resolve the discrepancy',4,
 ...
 ['Visitors who have paid to enter stay longer and are more likely to buy something than those who entered free',
  'The shop has extended its opening hours since the charge was introduced',
...
LIFT.update({
 'LL101': [('sell more copies in their first month', ' than they do over the remainder of their first year in print'),
           ('readers who have not previously bought books', ' from any publisher of commercial fiction'),
           ('recommend it to others more often', ' and recommend it to a wider circle of acquaintances'),
           ('abandon a novel do so during its opening chapters', ' rather than at any later point in the book, whatever its length')],
 'LL102': [('responsible for the majority of traffic deaths', ' recorded in the city'),
 ...
 'LL112': [('hold their meetings in the evening rather than during the day', ' or at the weekend'),
           ...
           ('have no effect at all on the level of crime', ' in the areas they serve'),
           ('reported with equal accuracy in all neighbourhoods', ' of the city, whatever their crime rate')],
 'LL113': [('knowing that it would disadvantage', ' the batteries it was comparing its own against'),
           ("would outlast the competitor's in a test of intermittent use", ' conducted under the same laboratory conditions'),
           ('Most purchasers use batteries of this kind intermittently', ' rather than drawing on them without interruption')],
 ...
 'LL117': [('No player has ever been retained after missing three consecutive', ' sessions in the period since the rule was adopted'),
           ('Training sessions are held on Monday, Wednesday and Friday', ' of each week throughout the whole of the playing season'),
 ...
 'LL118': [('more competitive than the markets in which the company previously failed', ' and has more established local firms operating in it'),
           ('unwound at a loss is worse for the company', ' once the damage to its reputation is taken into account'),
           ('no more capital available now than it had at the time', ' of the two earlier ventures that failed within three years'),
...
LIFT.update({
 'LL141': [('commission the hotel pays to travel sites has risen', ' in each of the three years just past'),
           ('Occupancy at the hotel is highest during the months', ' in which the city holds its largest conferences'),
           ("hotel's own site is easier to use on a telephone", ' than the sites most travellers book through'),
           ("members of the hotel's loyalty programme", ' and receive a discount on the published rate')],
 'LL143': [('Some restaurants in the city raised their prices after the increase', ' rather than reducing the hours they offered')],
 ...
 'LL150': [('say they find them repetitive', ' and would prefer them to be held less often than every week'),
           ...
           ('Your firm is smaller than most of the firms', " whose results the consultant's recommendation has been drawn from")],
...
LIFT.update({
 ...
 'LL238': [('extended its opening hours since the charge was introduced', ' at the entrance to the museum building since the charge began'),
