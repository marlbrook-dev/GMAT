...
q('LC101','11','lsat_rc_main',3,
 ...
 ['The deterrence rationale leaves the exclusionary rule exposed to an empirical objection, and the reading that would answer it is the one the Court has abandoned',
  'The exclusionary rule should be replaced by a remedy that compensates those subjected',
  'Studies of whether the exclusionary rule deters unlawful searches',
...
q('LC102','11','lsat_rc_stated',2,
 ...
 ['benefits only those against whom an unlawful search produced evidence',
  ...
  'applies unevenly across jurisdictions',
  'protects defendants at the expense of the victims',
...
q('LC106','11','lsat_rc_app',4,
 ...
 ['A safety regulation that penalises firms only when an unsafe practice has already caused an injury, leaving those exposed to the same practice without recourse',
  'A tax credit available only to firms that can document the expenditure',
  'A warranty that covers a product only during the first year after purchase',
  'A licensing rule that bars a firm from operating until it has passed',
...
q('LC107','11','lsat_rc_app',3,
 ...
 ['A justification that rests entirely on an effect must be abandoned or replaced if the effect cannot be demonstrated',
  ...
  'Empirical studies are a poor basis on which to settle questions',
...
q('LC110','12','lsat_rc_stated',3,
 ...
 ['the fungus takes the carbon and later releases it, making the fungus the agent',
  'the receiving plant is short of carbon',
  'the two plants belong to the same species',
  'the measurement technique cannot distinguish carbon',
...
q('LC112','12','lsat_rc_struct',4,
 ...
 ['describe how a metaphor accepted in advance shapes the interpretation of later evidence',
  'accuse researchers in the field of deliberately suppressing',
  'argue that the cooperative account has been refuted',
...
q('LC120','13','lsat_rc_app',4,
 ...
 ['A finder who adds a frame to an unattributed painting and thereby acquires title to the painting',
  'An editor who corrects the proofs of a novel and is paid a fee',
  'A translator who receives a copyright in the translation but not in the original',
...
q('LC124','14','lsat_rc_stated',3,
 ...
 ["the gains may have come from work that would otherwise have gone to someone else",
  "large programmes attract participants who are less motivated",
...
q('LC126','14','lsat_rc_struct',4,
 ...
 ["identify the question on which the two positions actually differ and note that it is unexamined",
  ...
  "propose a research programme that would combine the strengths",
...
q('LC128','14','lsat_rc_app',3,
 ...
 ["A field that requires evidence for its conclusions should require it also for its claims about its own methods",
  "Randomised trials should be abandoned in favour of judgments",
  "The limits of the randomised trial can be overcome by running trials",
...
q('LC129','15','lsat_rc_main',4,
 ...
 ["Passage B accepts the standard by which passage A defends its method and argues that the method has not been shown to meet it",
  "Passage B denies the premise on which passage A's argument rests",
  "Passage B agrees with passage A's conclusion but reaches it by a different route",
  "Passage B attributes to defenders of the method a motive that passage A",
...
q('LC134','15','lsat_rc_app',4,
 ...
 ["Whether a method of interpretation constrains the judges who use it is a question that matters to its defence",
  "Judges who describe themselves as originalists reach conclusions",
  "The historical record forecloses some propositions about eighteenth century",
...
q('LC135','15','lsat_rc_app',3,
 ...
 ["A study finds that originalist and non originalist judges are equally likely to reach the outcome their prior writings favour",
  "Historians agree about the original public meaning",
  "Self described originalists cite historical sources more often",
  "Courts have overturned several originalist decisions on historical grounds",
  "The historical record for contested provisions has grown larger"],
...
q('LC136','16','lsat_rc_main',3,
 ...
 ["The rejection of continental drift reflected a reasonable demand that the evidence available at the time could not satisfy",
  "Wegener's critics rejected continental drift because they were unwilling",
...
q('LC139','16','lsat_rc_inf',4,
 ...
 ["left the theory in the same position, because it could not supply the missing mechanism",
  ...
  "been rejected by physicists on the same grounds",
...
q('LC140','16','lsat_rc_struct',4,
 ...
 ["signal that the passage will defend the critics on grounds the usual account ignores",
  "argue that the geological establishment was in fact more receptive",
  ...
  "suggest that Wegener himself was responsible for the delay"],
...
q('LC143','17','lsat_rc_main',4,
 ...
 ["An objection usually taken as an argument against class actions is better understood as identifying what kind of proceeding a class action is",
  "Class actions should be abolished because absent members cannot control",
  "Judicial review of class settlements is inadequate because the parties",
...
q('LC147','17','lsat_rc_struct',4,
 ...
 ["explain why judicial review cannot do the work adversarial process does elsewhere",
  ...
  "show that the approval standard is less demanding than it appears",
...
q('LC149','17','lsat_rc_app',3,
 ...
 ["Their interests are asserted on their behalf, and nothing more follows from the relationship",
  "They are bound by the outcome but may withdraw at any point",
  "They select counsel indirectly through the member who files first",
  "They are consulted about the terms of any settlement",
...
q('LC150','18','lsat_rc_main',4,
 ...
 ["The crow findings establish tool use on an independent evolutionary line, and the inference to a general capacity should be drawn cautiously for reasons that apply to every species",
  "Tool use in New Caledonian crows is a narrow specialisation rather than a general",
...
q('LC154','18','lsat_rc_struct',4,
 ...
 ["accepts the conclusion the second paragraph supports while questioning the strength of one line of support for it",
  ...
  "offers an alternative explanation of the findings reported",
  "extends the second paragraph's findings to species other than crows",
  "concedes that the second paragraph's findings are inconsistent"],
...
q('LC155','18','lsat_rc_app',4,
 ...
 ["Crows transfer a solution learned with one kind of material to a problem requiring a different kind, without further training",
  "Crows in a new population are observed manufacturing hooks of the same design",
...
q('LC162','19','lsat_rc_app',4,
 ...
 ["A restorer who must decide which irregularities in a painting are damage and which are the painter's hand, and whose reasoning survives only in the finished surface",
  ...
  "A curator who selects which works from a collection to display and explains",
...
q('LC164','20','lsat_rc_main',4,
 ...
 ["Informality is not a single quantity waiting to be measured, and treating it as one distorts both the statistics and the policies built on them",
  "Currency based estimates of the informal sector are more reliable",
  "Programmes to formalise employment have failed to improve the conditions",
...
q('LC170','20','lsat_rc_app',3,
 ...
 ["Currency in circulation in those countries is inflated by cross border demand unrelated to informal work",
  "Household surveys in those countries are conducted by the same agencies",
  "Night time light estimates in those countries fall between the survey",
...
q('LC171','21','lsat_rc_main',4,
 ...
 ["Passage B accepts that the model passage A criticises was worse and argues that the reform relocates the exclusion rather than removing it",
  ...
  "Passage B agrees with passage A about who bears the cost",
...
q('LC175','21','lsat_rc_struct',4,
 ...
 ["answer an objection by distinguishing the funding model from the process the objection concerns",
  "supply evidence that open access journals maintain the same standards",
  ...
  "introduce the argument that the public should be able to read"],
...
q('LC177','21','lsat_rc_app',3,
 ...
 ["The subscription model excluded people who should have had access to published research",
  ...
  "The share of authors from lower income countries is the right measure",
...
q('LC185','11','lsat_rc_main',4,
 ...
 ["A justification is stated, two objections are raised, one is answered at a cost, and a third position is described as immune and unavailable",
  "Three justifications for a rule are stated and compared, and the strongest",
  "An objection is stated, answered, and then restated in a stronger form",
...
q('LC188','17','lsat_rc_main',4,
 ...
 ["stating a justification, identifying what it leaves out, showing that the usual safeguard cannot supply it, and reinterpreting the proceeding",
  "setting out two competing justifications for a procedure and choosing",
  "describing a procedure, cataloguing its abuses, and proposing statutory reform",
  "arguing that a procedure should be abolished and answering the objections",
  "comparing a legal procedure with a regulatory one and finding the comparison"],
...
q('LC189','19','lsat_rc_main',3,
 ...
 ["show that a familiar debate is settled in different directions for different parts of a text, and to name the question that follows",
  "argue that foreignisation is the more faithful of the two approaches",
  "describe the history of the debate between domestication and foreignisation",
  "recommend that translators state their policy before beginning",
...
LIFT = {
 'LC101': [("protects the integrity of judicial proceedings rather than", " the interests of any of the parties who happen to be before the court in a particular case"),
           ("Studies of whether the exclusionary rule deters unlawful searches", " have been carried out repeatedly over several decades and have settled nothing about whether it does"),
           ("should be replaced by a remedy that compensates those subjected", " to an unlawful search that turned up nothing incriminating, rather than excluding evidence at trial"),
           ("have misunderstood the purpose the rule was adopted", " to serve, and the objections they raise against it miss that purpose entirely as a result")],
 ...
 'LC103': [("assumes that the rule was adopted to compensate", " those subjected to an unlawful search"),
           ("relies on studies whose results are too weak to be decisive", " and too contested to settle the question")],
 'LC106': [("A tax credit available only to firms that can document the expenditure", " it is meant to encourage, which the smallest firms, least able to afford the paperwork, cannot produce"),
           ("A licensing rule that bars a firm from operating until it has passed", " an inspection conducted at the firm's own expense by the regulator before it is permitted to trade at all"),
 ...
 'LC107': [("Empirical studies are a poor basis on which to settle questions", " of constitutional doctrine, however well they are conducted"),
 ...
 'LC108': [("Experiments giving plants and fungi conflicting interests have shown", " the cooperative account to be false in every case in which it has been tested")],
 ...
 'LC112': [("argue that the cooperative account has been refuted", " by the findings that do not fit its predictions"),
...
LIFT.update({
 ...
 'LC128': [("Statistical adjustment is an adequate substitute for randomisation", " wherever randomisation cannot be arranged for practical or ethical reasons"),
           ("The limits of the randomised trial can be overcome by running trials", " in a sufficient number of different settings"),
           ("Randomised trials should be abandoned in favour of judgments", " about the mechanisms that produce an effect in a given setting")],
 'LC129': [("denies the premise on which passage A's argument rests", " and offers an alternative method of interpretation in its place"),
           ("attributes to defenders of the method a motive that passage A", " does not address or even acknowledge anywhere in its argument")],
 'LC134': [("Judges who describe themselves as originalists reach conclusions", " that track their prior political commitments closely"),
           ("A method of interpretation that cannot be shown to be wrong", " is for that reason unacceptable for use in a court of law"),
           ("The historical record forecloses some propositions about eighteenth century", " usage that were once thought to be open questions"),
           ("Contemporary values have no determinate content", " that a judge could consult or apply in deciding a contested case")],
 'LC135': [("The historical record for contested provisions has grown larger", " as more archives of the founding period are digitised and indexed"),
           ("Historians agree about the original public meaning", " of most of the constitutional provisions that are litigated before the courts"),
           ("Self described originalists cite historical sources more often", " in their written opinions than other judges on the same courts do")],
 'LC136': [("Geologists apply a stricter standard to theories proposed by outsiders", " than to those proposed by colleagues within their own discipline"),
           ("critics rejected continental drift because they were unwilling", " to consider seriously an idea that was unfamiliar to them")],
...
LIFT.update({
 ...
 'LC143': [("Judicial review of class settlements is inadequate because the parties", " who assemble the record the judge relies on both want the settlement approved"),
           ("Class actions should be abolished because absent members cannot control", " the claims that are brought and settled on their behalf by counsel they did not choose"),
           ("The access justification for class actions is the only one", " that withstands any serious examination of the procedure and of how it operates in practice")],
 ...
 'LC150': [("Human reasoning is better described as a bundle of narrow specialisations", " than as a single general capacity that can be applied to whatever new problems happen to arise in the course of a life"),
           ("Tool use in New Caledonian crows is a narrow specialisation rather than a general", " reasoning capacity of the kind that primates have long been held to possess and to bring to new problems")],
 ...
 'LC154': [("concedes that the second paragraph's findings are inconsistent", " with what the first paragraph reported about captive crows"),
           ("offers an alternative explanation of the findings reported", " in the second paragraph about crows raised by hand in captivity"),
 ...
 'LC155': [("Crows in a new population are observed manufacturing hooks of the same design", " as those described in the earlier studies of the species"),
...
LIFT.update({
 'LC162': [("A curator who selects which works from a collection to display and explains", " the choice in a printed catalogue that visitors can read alongside the works themselves in the gallery"),
 ...
 'LC164': [("Programmes to formalise employment have failed to improve the conditions", " under which the people they succeed in registering actually carry out their work"),
           ("Currency based estimates of the informal sector are more reliable", " than the survey based estimates that national statistical agencies usually prefer"),
           ("Aggressive enforcement causes respondents to conceal informal activity", " from the household surveys on which the official figures for the sector rest")],
 ...
 'LC171': [("Passage B agrees with passage A about who bears the cost", " of publication but disagrees about whether that cost is justified by what it pays for")],
 ...
 'LC185': [("An objection is stated, answered, and then restated in a stronger form", " that the answer given earlier does not meet, and the passage ends without resolving it"),
           ("Three justifications for a rule are stated and compared, and the strongest", " of the three is then identified and defended at length against the others")],
 'LC188': [("arguing that a procedure should be abolished and answering the objections", " that have been raised against abolishing it altogether rather than reforming it"),
           ...
           ("setting out two competing justifications for a procedure and choosing", " between them on the strength of the evidence that is available to each side")],
 'LC189': [("argue that foreignisation is the more faithful of the two approaches", " to the translation of any literary work at all, of whatever kind"),
           ("recommend that translators state their policy before beginning", " work on a translation of any appreciable length or literary difficulty")],
}); 
