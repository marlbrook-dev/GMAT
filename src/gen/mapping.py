...
#
# Principle has no counterpart in the pool and stays hand written. Conclusion, structure
# and the parallel reasoning half of explanation have none here either; they are generated
# by g_lsat_concl.py, g_lsat_struct.py and g_lsat_parallel.py, which are written against the
# LSAT's own categories and so are wired in build_banks.EXAM_EXTRA.
LSAT_MAP = {
