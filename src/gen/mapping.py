...
#
# Principle and explanation have no counterpart in the pool and stay hand written.
# Conclusion and structure have none here either; they are generated by g_lsat_concl.py and
# g_lsat_struct.py, which are written against the LSAT's own categories and so are wired in
# build_banks.EXAM_EXTRA.
LSAT_MAP = {
