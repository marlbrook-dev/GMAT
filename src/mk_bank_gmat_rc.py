...
q('V604','A','v_inf','Inference',4,
 ...
 ['leave the conflict of interest in place so long as ratings remained embedded in regulation',
  ...
  'eliminate the conflict of interest but at an unacceptable cost',
...
q('V613','C','v_st','Main idea',3,
 ...
 ['arguing that a trading league enforced its rules collectively rather than through individual reputation',
  'explaining why the Hanseatic League never established a court',
...
q('V624','D','v_inf','Author agreement',4,
 ...
 ['correct on its own terms while leaving out the constraint that ended the discovery era',
  ...
  'adequate for the period before 1962',
...
q('V645','H','v_st','Structure',4,
 ...
 ['show that the existing figure is not a cautious estimate but one the evidence excludes',
  ...
  'suggest that national accounts were designed before depletion',
...
q('V648','H','v_inf','Application',4,
 ...
 ['A firm should record a rough estimate of an uncertain liability rather than carry it at nothing, since nothing is the one figure known to be false',
  ...
  'A firm should disclose the disagreement among its experts',
...
q('V649','I','v_st','Main idea',4,
 ...
 ['refining the standard account of a case of technological lock in by identifying what the installed base contributed',
  ...
  'showing that network effects were not understood',
  'explaining why the broad gauge survived until 1892'],
...
q('V655','J','v_st','Main idea',3,
 ...
 ['present two non genetic explanations of a social arrangement and draw out what they imply for a genetic one',
  'establish that naked mole rats are more closely related to insects',
...
q('V657','J','v_st','Stated detail',3,
 ...
 ['dispersal through the soil the animals inhabit is close to fatal',
  ...
  'a single breeding female produces more offspring',
...
q('V661','K','v_st','Main idea',3,
 ...
 ['reinterpreting the mechanism by which a revenue source was lost, and drawing a general caution from it',
  ...
  'proposing a business model that would allow newspapers to recover'],
...
q('V664','K','v_inf','Inference',4,
 ...
 ['the news operation had been supported by classified revenue rather than the reverse',
  'readers would tolerate a reduction in coverage',
  'listing sites would eventually raise their prices to newspaper levels',
  'classified advertising could be restored',
...
q('V672','L','v_inf','Application',4,
 ...
 ['Documenting, for each eruption date in use, which records contributed to it and which did not',
  ...
  'Reassessing the written accounts for evidence of copying',
...
q('V673','M','v_st','Main idea',4,
 ...
 ['showing that two opposed views of an institution are compatible, and why that leaves the central question unanswerable',
  'arguing that craft guilds were cartels whose abolition',
...
q('V679','N','v_st','Main idea',3,
 ...
 ['distinguish the advantage a resource genuinely offers from a broader one often claimed for it',
  ...
  'explain how the spring and neap cycle affects the output',
...
q('V688','O','v_inf','Inference',4,
 ...
 ['changes slowly, while a manufacturing problem appears as a step',
  'is the same across markets once seasonal effects',
...
q('V691','P','v_st','Main idea',3,
 ...
 ['present a single mechanism proposed to explain a cluster of traits, and state what would test it',
  'argue that selection for tameness is sufficient to explain all traits',
...
q('V702','Q','v_inf','Application',4,
 ...
 ['Identify the physical property the traditional form supplied and provide it by whatever means the new materials allow',
  ...
  'Measure the performance of existing traditional buildings'],
...
q('V703','R','v_st','Main idea',3,
 ...
 ['question a mechanism both sides of a policy debate assume, and identify the instrument that assumption overlooks',
  ...
  'demonstrate that residents of floodplains are poorly informed',
  'explain why building in floodplains has continued',
...
q('V708','R','v_inf','Application',4,
 ...
 ['Households that were informed of their floodplain designation went on to buy at the same rate as those who were not',
  'Premiums under the federal programme are further below actuarial cost',
...
q('V709','S','v_st','Main idea',3,
 ...
 ['describing a measure that distinguishes two situations a species count conflates, and the estimation problem it faces',
  'arguing that conservation budgets have been spent on corridors',
  ...
  'comparing observed richness with dark diversity across a range'],
...
q('V721','U','v_st','Main idea',4,
 ...
 ['reinterpreting a threat as a metabolic cost rather than a chemical barrier, and saying what that changes',
  ...
  'establishing that ocean acidification poses a smaller threat',
  'describing the chemistry by which dissolved carbon dioxide lowers the pH',
...
q('V737','W','v_inf','Inference',5,
 ...
 ['the South Slavic singers were doing the same thing as the Homeric composers rather than something similar',
  ...
  'formulaic density can be measured on a common scale',
...
q('V739','X','v_st','Main idea',3,
 ...
 ['identifying the saving that mattered most in a transport innovation, and using it to explain two otherwise puzzling patterns',
  ...
  'comparing the congestion of major ports before and after containers'],
...
LIFT = {
 ...
 'V601': [('systematically inflate the ratings they are paid to issue', ' in order to keep the business of the issuers who pay them'),
          ('photocopier was the decisive cause of a change in an industry business model', ' and that no other development of the period contributed'),
          ('tracing the history of credit rating from subscription sales to the issuer pays model', ' and identifying the decade in which the change took place'),
          ('public body should assign rating agencies to issuers', ' in place of the arrangement under which issuers choose their own')],
 'V613': [('never established a court', ' of its own with power to compel its members'),
          ('commercial success of the Hanseatic League relative to its rivals', ' in the Baltic and the North Sea over three centuries'),
          ('embargoes are generally more effective than legal judgments', ' at securing compliance from a distant party'),
          ('geographic obstacles to communication among Baltic ports', ' during the centuries before steam navigation')],
 'V624': [('unfalsifiable, since any absence of discovery can be attributed to weak incentives', ' after the fact'),
          ('adequate for the period before 1962', ', when the golden age of screening ended, but not for the decades since'),
          ('inconsistent with the record of discovery between 1940 and 1962', ' by a method that was then still productive'),
          ('defence of inaction dressed up as an analysis of incentives', ' by the firms whose incentives it describes')],
 'V629': [('stronger evidence against the form than its critics have recognised', ' in the three decades since it was first measured'),
          ('later literature set out to reproduce and could not', ' using data on segments from before acquisition'),
          ('confined to conglomerates in economies with deep capital markets', ' where external lenders can verify quality for themselves'),
          ('artefact of the accounting conventions used in the 1990s', ' that governed segment reporting at the time')],
 'V639': [("cultural nationalism was the programme's official rationale", ' from the beginning'),
 ...
 'V649': [('broad gauge survived until 1892', ' in the face of a parliamentary decision taken forty six years earlier'),
          ('network effects were not understood', ' by any of the engineers who gave evidence to the parliamentary commissioners'),
          ('engineering advantages of the broad gauge over the narrow gauge', ' in speed, steadiness and the size of locomotive it permitted'),
          ('Parliament was mistaken to select the narrow gauge in 1846', ' on the evidence that was before it at the time')],
 'V657': [('single breeding female produces more offspring', ' than the colony can support'),
          ('colonies grow faster than the available tuber supply can sustain', ' in any given season'),
          ('sex ratio in a colony is heavily skewed toward females', ' from the first generation onward'),
          ('workers live long enough to inherit the breeding position', ' should she die')],
 'V664': [('classified advertising could be restored', ' at a lower rate per line if the paper became cheaper to produce'),
          ('readers would tolerate a reduction in coverage', ' of the kind the cuts produced without cancelling subscriptions'),
          ('display advertising would replace the revenue that classifieds had provided', ' within a few years'),
          ('listing sites would eventually raise their prices to newspaper levels', ' once the classifieds had gone')],
 'V673': [('guild courts enforced apprenticeship contracts in both directions', ' for the full length of the agreed term of years'),
          ('craft guilds were cartels whose abolition', ' cleared the way for the factory system that eventually replaced them'),
          ('cities without guilds developed no comparable training institutions', ' for transmitting a craft from one generation to the next'),
          ('guild towns grew more slowly than towns without guilds', ' over the whole period for which records survive')],
 'V679': [('spring and neap cycle affects the output', ' of a plant over the course of a single lunar month'),
          ('tidal power is unsuitable for supplying electricity at scale', ' to a grid of any appreciable size'),
          ('forecasting accuracy of tidal, wind and solar generation', ' over horizons of a week or more in ordinary operation'),
          ('tidal sites in different basins be developed together', ' as a single portfolio under one operator')],
 'V688': [('same across markets once seasonal effects', ' have been taken out of the series'),
          ('proportional to the price of the product in every market', ' at the point of sale'),
          ('measured directly for each distribution channel', ' from the claims already filed'),
          ('falls as a product ages within its coverage period', ' whatever its failure rate')],
 'V697': [('perform better thermally than modern ones', ' built to the same plan in the same climate'),
          ('building materials characteristic of hot dry, hot wet and cold regions', ' and the forms that each of those materials permits'),
          ('thermal mass is the most important property of a building envelope', ' a designer working in any material can specify'),
          ('architects who build in concrete rather than in traditional materials', ' in places where an older material was available')],
 'V703': [('premiums should be raised to actuarial levels', ' over a period of years rather than at once'),
          ...
          ('fiscal and behavioural arguments for reforming flood insurance', ' as they are usually put by each side of the debate'),
          ('building in floodplains has continued', ' through decades of heavy losses that are a matter of public record')],
 'V712': [("raise the site's dark diversity by expanding its effective regional pool", ' beyond its present limits'),
          ("reduce the site's observed richness by introducing competitors", ' for the same resources'),
 ...
 'V727': [('should abandon group meetings as well as group liability', ' and lend to individual borrowers directly rather than through groups at all'),
 ...
 'V737': [('fieldwork was conducted before the singers had heard written versions', ' of any of the epic material that they themselves went on to perform'),
          ('formulaic density can be measured on a common scale', ' across languages, metres and quite separate performance traditions'),
          ('Greek and South Slavic traditions descend from a common source', ' rather than merely resembling one another in their outward form'),
          ('recorded South Slavic epics are as long as the Homeric poems', ' and are organised on very much the same scale')],
...
LIFT3 = {
 ...
 'V602': [('legal immunity from suits brought by investors who relied on their ratings', ' after a default'),
          ('statutory obligation to disclose the methodology behind each rating', ' at the time the rating is published'),
          ('reproduce their reports cheaply for a mass readership', ' without the consent of a subscriber')],
 'V606': [('software vendor commissions an independent benchmark of its own product and publishes the result', ' before releasing the next version of the product'),
          ('magazine sells advertising space to the companies whose products it reviews', ', while its editors have no say in which products are reviewed'),
          ('university pays an accreditation body a fee proportional to its enrolment', ' on a schedule that is published in advance each year and reviewed by the trustees of both bodies')],
 'V615': [('embargoes were difficult to coordinate across the Baltic', ' within a single sailing season'),
 ...
 'V623': [('isolation chip should be funded in preference to any economic reform', ' that has so far been proposed by anyone'),
 ...
 'V630': [('divested divisions saw their own share prices rise on the announcement', ' rather than on completion'),
          ('larger for conglomerates with more divisions than for those with fewer', ' in the same set of industries'),
 ...
 'V645': [('three measurement methods should be averaged rather than compared', ' before any figure is published'),
 ...
 'V648': [('defer recognising a liability until its amount can be determined within a narrow range', ' by a method the profession has accepted for that class of liability'),
          ('disclose the disagreement among its experts', ' in a note to the accounts rather than publish any single figure in the accounts themselves'),
 ...
 'V658': [('behaviour of workers while the other emphasises the behaviour of the breeding female', ' who does not forage'),
          ('conditions inside the colony while the other emphasises conditions outside it', ' in the surrounding soil'),
          ('genetic relatedness while the other emphasises environmental constraint', ' of a kind mammals do not share')],
 'V661': [('newspapers were wrong to reduce newsroom costs after losing classified revenue', ' in the years that followed'),
          ('business model that would allow newspapers to recover', ' the revenue the listing sites took from them'),
          ('online listing sites undercut the price of classified advertising', ' in every market they entered')],
 'V666': [('portfolio of products whose revenues are uncorrelated with one another', ' across the business cycle'),
          ('sells a product at a loss in order to profit from the supplies it consumes', ' over the life of the product'),
          ('invests in research whose commercial value cannot be estimated in advance', ' by anyone inside the firm')],
 'V672': [('Reassessing the written accounts for evidence of copying', ' from one chronicle to another during the same decades'),
          ('Measuring sulphate concentrations in the ice with greater precision', ' at every depth in the core and across several cores'),
 ...
 'V681': [('grid operators have misunderstood the nature of tidal generation', ' and the reserve capacity it calls for'),
          ('sites with different tidal phases be combined', ' into a single smoother supply for the grid'),
          ('demand could be reshaped to fit the tidal generation profile', ' by moving load into the hours when the tide is running')],
 'V684': [('produce any quantity ordered but cannot predict what will be ordered', ' from one week to the next'),
          ('deliveries are frequent but whose quality varies without warning', ' from one consignment to another'),
 ...
 'V696': [('doubtful that any single mechanism could explain a cluster of this breadth', ' spanning behaviour, anatomy and pigmentation'),
          ('convinced that it has been established by the silver fox experiment', ' and the forty generations of selection it ran for'),
 ...
 'V706': [("increase the accuracy of residents' beliefs about their own risk", ' within a season or two'),
          ('reduce the number of households carrying flood insurance at all', ' in designated areas'),
          ('be opposed chiefly by insurers rather than by homeowners', ' who bear the premium')],
 'V709': [('species co occurrence is an unreliable guide to habitat suitability', ' in any region that has been surveyed to a reasonable standard'),
          ('conservation budgets have been spent on corridors', ' that the species they were built for would never have used'),
          ('comparing observed richness with dark diversity across a range', ' of habitat types, survey intensities and regional pools')],
 'V715': [('growth of firm size and correspondence volume in the late nineteenth century', ' and the reorganisation of clerical work that followed in the larger firms'),
          ('typewriter had no effect on the composition of the clerical workforce', ' at any point during the decades in question'),
 ...
 'V721': [('ocean acidification poses a smaller threat', ' to calcifying organisms than to other marine life'),
          ('laboratory experiments on ocean acidification have been poorly designed', ' from the outset of the research programme'),
 ...
 'V739': [('dockworkers were displaced more slowly than is usually claimed', ' in the ports that were the first to convert to containers'),
          ('congestion of major ports before and after containers', ' had come into general use on the main shipping routes of the world'),
 ...
 'V743': [('shipping lines were reluctant to retire serviceable break bulk vessels', ' while they still earned'),
          ('importers had not yet learned to schedule shipments to the day', ' against a reliable sailing'),
          ('dockworkers in most ports resisted the new handling methods', ' for as long as they could')],
}
E.extend(I, LIFT3, 'LIFT3')

LIFT2 = {
 # two, so the key becomes the middle option
 'V604': [('resisted by investors, who would have to pay for what they now receive free', ' out of returns that are already thin'),
          ('eliminate the conflict of interest but at an unacceptable cost', ' to the breadth of market coverage')],
 'V616': [('minutes were the only documents that member towns were required to preserve', ' in their own archives'),
          ('assemblies met more frequently than any other body the League maintained', ' over the course of its history')],
 'V632': [('organic material enriching the sediment around the carcass', ' in the first year or two'),
          ('migration of species from nearby hydrothermal vents', ' across the abyssal plain')],
 'V646': [('no more useful than the current figure, since both are subject to large error', ' of unknown size in either direction'),
          ('acceptable only as a temporary measure until the three methods converge', ' on a single figure for the stock remaining')],
 'V660': [('solitary mole rat species is found to tunnel as extensively as eusocial species do', ' in the same soil conditions'),
          ('colonies are found to contain more than one breeding female in some seasons', ' when food is plentiful')],
 'V667': [('dates of several large volcanic eruptions of the first millennium', ' from two records that are independent of one another'),
          ('ice core chronologies are less reliable than tree ring chronologies', ' at every depth below the surface of the core')],
 'V683': [('backup source with the same output profile as the tidal plant', ' running alongside it'),
 ...
 'V708': [('Premiums under the federal programme are further below actuarial cost', ' than the programme itself has reported in any of its filings'),
          ('Floodplain residents who have experienced a flood remain in place at high rates', ' for years afterwards rather than relocating')],
 ...
 'V733': [('writing was genuinely unavailable in Greece at the relevant period', ' when the poems took their present shape'),
          ('Homeric poems were composed in writing rather than orally', ' by a single author working with a written text')],
 'V741': [('shipping companies underinvested in containerisation as a result', ' for most of a decade'),
...
LIFT1 = {
 ...
 'V607': ('shade grown coffee is superior to sun grown coffee in Central America', ' wherever altitude and rainfall permit either'),
 'V626': ('segments outperformed comparable freestanding firms in the years after acquisition', ' on every measure'),
 'V636': ('support fewer chemosynthetic species than a vent of comparable size', ' at the same depth'),
 'V655': ('naked mole rats are more closely related to insects', ' than to the other rodents with which they are usually classed'),
 'V662': ('commanded higher rates per column inch than display advertising did', ' in most markets and in most years of the period'),
 'V677': ('difficult to reconcile with the records of the guild courts', ' that survive'),
 'V686': ('purchased the product directly from the manufacturer rather than through a dealer', ' and registered it'),
 'V702': ('Measure the performance of existing traditional buildings', ' in the same climate for a full year before committing to a design'),
 'V710': ('present but too rare to be detected by standard survey methods', ' in a single season'),
 'V725': ('warming has been slowest and food supply most stable', ' through the year in the regions concerned'),
 'V735': ('introduce the claim that writing was available in Greece earlier than supposed', ' before the poems were fixed'),
}
