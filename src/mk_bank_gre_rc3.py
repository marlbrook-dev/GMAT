...
LIFT = {
 ...
 'GR120': [('in every respect but age', ' and general health'),
           ...
           ('smaller than the population that eventually receives the drug', ' once it is approved'),
 ...
 'GR128': ('consolidation paused while the wage gap held, migration to the cities slowed', ' in the same decade'),
 ...
 'GR142': [('acquired its vocabulary for horses', ' and their colours'),
           ...
           ('corpora be assembled for languages that currently lack them', ' as a matter of priority')],
