...
{id:'D262',section:'DI',type:'MSR',domain:'nonmath',skill:'di_msr',diff:4,passageHtml:MSR_SET3,
 ...
 choices:['Alder Farm','Cedar Orchards','Birch Bakery','Dune Coffee','Elm Woodcraft'],answer:1,
...
{id:'D263',section:'DI',type:'MSR',domain:'nonmath',skill:'di_msr',diff:4,passageHtml:MSR_SET3,
 ...
 choices:['Both Birch Bakery and Dune Coffee receive double stalls','Birch Bakery receives a double stall and Dune Coffee does not','Dune Coffee receives a double stall and Birch Bakery does not','Neither vendor can receive a double stall','Elm Woodcraft receives the remaining double stall'],answer:2,
...
{id:'D264',section:'DI',type:'MSR',domain:'math',skill:'di_msr',qskill:'q_rrp',diff:3,passageHtml:MSR_SET3,
 ...
 choices:['20 dollars','40 dollars','55 dollars','35 dollars','70 dollars'],answer:3,
